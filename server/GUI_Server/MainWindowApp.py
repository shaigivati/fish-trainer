...
class MainWindowApp(Tkinter.Tk):
    ...
    def __init__(self, log):
        ...
        add_step = feed.add_program_step(1,'right',100, 20)
        add_step = feed.add_program_step(2, 'left', 200, 30)
    ...
    def onExit(self):
        ...
        pin_num_str = '{0}{1}'.format(2, 'R') #create 1L/1R str
        pin_dir_str = '{0}{1}{2}'.format(2, 'R', 'D') #create 1L/1R str
