...
class MainWindowApp(Tkinter.Tk):
    ...
    def __init__(self, log):
        ...
        add_step = feed.add_program_step(3, 'left', 30, 0.5)
        add_step = feed.add_program_step(4, 'wait', 0.4)
        add_step = feed.add_program_step(5, 'right', 60, 0.5)
        add_step = feed.add_program_step(6, 'wait', 0.4)
        add_step = feed.add_program_step(7, 'left', 60, 0.5)

        add_step = feed.add_program_step(8, 'wait', 1.4)
        add_step = feed.add_program_step(9, 'left', 60)
